...
export const publicApiService = {
  ...
  createTreatment: (caseId, formData) => publicApi.post(`/animal-cases/${caseId}/treatments`, formData, {
    headers: { 'Content-Type': 'multipart/form-data' }
  }),
  getTreatmentById: (id) => publicApi.get(`/animal-cases/treatments/${id}`),
  updateTreatment: (id, formData) => publicApi.put(`/animal-cases/treatments/${id}`, formData, {
    headers: { 'Content-Type': 'multipart/form-data' }
  }),
